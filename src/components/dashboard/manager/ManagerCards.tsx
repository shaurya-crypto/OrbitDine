...
import { Users, Receipt, Clock, CheckCircle2 } from "lucide-react";
...
export function ManagerCards({ restaurantId }: { restaurantId: string }) {
  ...
  const cards = [
    ...
    { title: "Orders In Queue", value: overview.ordersInQueue, icon: <Clock size={20} className="text-blue-400" />, bg: "bg-blue-500/10" },
